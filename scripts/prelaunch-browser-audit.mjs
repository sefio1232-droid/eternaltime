...
const routes = [
  ...
  { label: "catalog-citizen", path: "/watches/citizen" },
  ...
  { label: "watch-citizen-no-image", path: "/watches/citizen/aw181859l" },
  { label: "journal", path: "/journal" },
  { label: "article-mechanical", path: "/journal/pochemu-mekhanicheskie-chasy-populyarny" },
  { label: "article-brand-guide", path: "/journal/kak-vybrat-brend-chasov" },
  { label: "article-investment", path: "/journal/chasy-kak-investitsiya" },
