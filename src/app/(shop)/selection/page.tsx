...
export const metadata: Metadata = {
  ...
  description:
    "Семь коротких вопросов помогут выбрать несколько моделей Eternal Time по назначению, посадке, характеру, механизму, цвету циферблата, важным характеристикам и бюджету.",
  alternates: {
    canonical: "/selection",
  },
};
