    ...
    <Container className="grid gap-12 py-10 lg:py-14">
      <header className="grid gap-5 lg:grid-cols-[0.78fr_1.22fr] lg:items-end">
        <div>
          ...
          <h1 className="type-page mt-3 text-3xl text-balance md:text-5xl">Разные языки часов в одном каталоге</h1>
        </div>
      ...
      <section className="grid gap-10">
        {resultState.brands.map((brand, index) => {
          ...
          return (
            <article
              key={brand.slug}
              className={`grid gap-7 border-t border-[var(--border)] pt-8 ${
              ...
              <div className="grid content-start gap-4">
                ...
                {brand.collectionNames.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {brand.collectionNames.slice(0, 5).map((collectionName) => (
