...
const manifestCache = new Map<string, Promise<CasioPhotoArchiveManifest | null>>();
const zipCache = new Map<string, Promise<JSZip>>();

function cachedManifest(manifestPath: string): Promise<CasioPhotoArchiveManifest | null> {
